...
-- 导出 authplat2 的数据库结构
CREATE DATABASE IF NOT EXISTS `authplat2` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `authplat2`;


-- 导出  表 authplat2.company 结构
...
-- 导出  表 authplat2.auth_file_info 结构
