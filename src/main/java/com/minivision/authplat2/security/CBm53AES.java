...
//        System.out.println("length -->" + hex.length );
        while (hexI < hex.length && hex[hexI] > 0) {
...
//        char mingwen[] = "1234561234561234561234561234123412".toCharArray();
//        char[] miwen_hex = new char[1024];
//
//        char[] result = new char[1024];
//
//        char key[] = "fgert45rert".toCharArray();
//        CBm53AES aes = new CBm53AES(key);
//        aes.CipherStr(mingwen, miwen_hex);
//        System.out.println(miwen_hex);
